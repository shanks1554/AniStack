...
class DataProcessor:
    ...
    def scale_ratings(self):
        try:
            ...
            logger.info("Sclaing done for Processing")
        except Exception as e:
    ...
    def encode_data(self):
        try:
            ...
            logger.info("Logging done for users and anime successfully")
        except Exception as e:
            raise CustomException("Failed to encode data",sys)
        
    def split_data(self, test_size=15000, random_state = 43):
        try:
    ...
    def save_artifacts(self):
        try:
            ...
            joblib.dump(self.X_train_array,os.path.join(X_TRAIN_ARRAY))
            ...
            logger.info("All the training, testing data as well as rating_df data is saved now...")
        except Exception as e:
    ...
    def process_anime_data(self):
        try:
            ...
            raise CustomException("Failed to save anime and anime synopsis data",sys)
